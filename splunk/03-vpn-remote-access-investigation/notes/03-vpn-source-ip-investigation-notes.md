# Query 03 – VPN Source IP Investigation

## Objective

Identify source IP addresses generating high volumes of VPN activity and determine how many users, locations, and event types are associated with each source.

## Data Source

- Splunk index: `main`
- Source: `vpn.csv`
- Data type: VPN and remote-access activity
